...
app.post('/SignUp', (req, res)=>{
    ...
    const insertQuery = "INSERT INTO SignUp (username, f_name, l_name, Email, password) VALUES (?, ?, ?, ?, ?)"
    const checkUniqUsername = "SELECT * FROM SignUp where username=?"
...
app.listen('3000', ()=>{console.log('we are on the localhost:3000')})
